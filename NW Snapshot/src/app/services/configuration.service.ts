...
export class ConfigurationService {
  ...
  setConfigObject(res?) {
    ...
    this.nwSnapshotPod = res && res.NWSNAPSHOT_POD ? res.NWSNAPSHOT_POD : '';

    this.forecastSocket = res && res.FORECAST_SOCKET ? res.FORECAST_SOCKET : '';
    this.clusteringSocket = res && res.ANOMALY_SOCKET ? res.ANOMALY_SOCKET : '';
    this.profilerSocket = res && res.PROFILER_SOCKET ? res.PROFILER_SOCKET : '';
    this.nwSnapshotSocket = res && res.NWSNAPSHOT_SOCKET ? res.NWSNAPSHOT_SOCKET : '';
    ...
    this.nwSnapshotBaseUrl = this.appHost + 'backend/' + this.nwSnapshotPod;
  }
  ...
  setWebSocketUrl() {
    const webSocketUrl = this.nwSnapshotSocket;
    return webSocketUrl;
  }
