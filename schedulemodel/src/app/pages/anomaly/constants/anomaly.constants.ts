...
export const ANOMALY_URLS = {
    ...
    GET_ANM_TABLE_DATA_API: '/api/v1/anomalies/anomalies*/',
    ...
    POST_ANOMALY_SCHEDULE_PROFILING_API: '/api/v1/anomalies/profiling',
    GET_ANOMALY_PROFILING_RESULT_API: '/api/v1/anomalies/',
    ...
    GET_ANOMALY_DATASETS: 'getAnomalyDataSets/',
    GET_DATA_SOURCE_FEATURES_API: '/datasource/api/getFeatures',
};
