...
export class ConfigurationService {
  ...
  setConfigObject(res?) {
    ...
    // this.forecastBaseUrl = this.requestType + this.ipHost + ':' + this.forecastPod;
    // this.anomalyBaseUrl = this.requestType + this.ipHost + ':' + this.anomalyPod;
    // this.schedulerBaseUrl = this.requestType + this.ipHost + ':' + this.schedulerPod;
    // this.dataInsightsBaseUrl = this.requestType + this.ipHost + ':' + this.dataInsightsPod;
    // this.correlationBaseUrl = this.requestType + this.ipHost + ':' + this.correlationPod;
    // this.profilerBaseUrl = this.requestType + this.ipHost + ':' + this.classificationPod;
    // this.elBaseUrl = this.requestType + this.ipHost + ':' + this.elPod;
  }
