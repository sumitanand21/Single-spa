REPO_NAME="correlation_ui"
OKD_TEMPLATE_REPO="OKD_templates"
OKD_TEMPLATE_BRANCH="feature/VAX2.1"
OKD_TEMPLATE_PATH="microservices"
OKD_PROJECT="micro-correlation"
OKD_NAME="micro-correlation"
OKD_APP="micro-correlation"
BRANCH="mfe/correlation"
...
oc project $OKD_NAME
#cd $REPO_NAME
oc new-app dep.yaml -p DOCKER_FONTEND_IMAGE_NAME=$DOCKER_REG_TEMPLATE/$REPO_NAME:$COMMIT -p NFS_SERVER=$NFS_SERVER
