...
@Component({
  ...
  template: `<div class="row" [ngClass]="{'mapp-group': navApp && contentApp}" >
  ...
  <div #appVertContainer></div>
   ...
   styleUrls: ['./spa-host-v1.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SpaHostV1Component implements OnInit, OnDestroy {
