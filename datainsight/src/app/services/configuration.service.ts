...
export class ConfigurationService {
  ...
  setConfigObject(res?) {
    ...
    this.notifcationsPod = res && res.DATAINSIGHT_POD ? res.DATAINSIGHT_POD : '';
    this.serverConfigurationPod = res && res.SERVERCONFIGURATION_POD ? res.SERVERCONFIGURATION_POD : '';
    ...
    this.notifcationsBaseUrl = this.appHost + 'backend/' + this.notifcationsPod;
    ...
    this.serverConfigurationUrl = this.appHost + 'backend/' + this.serverConfigurationPod;
  }
  ...
  setWebSocketUrl() {
    const streamDataWebSocketUrl = this.dataInsightsSocket;
    return streamDataWebSocketUrl;
  }
}
